...
package mvc.view
{
   ...
   // public static const SLIDER_CHANGE:String = 'Slider Change';
    ...
    private var m;
		...
		public function Vslider( controller,main,target,thumb,left,right,time,plus,start){
			super();
            ...
            function loop(e:Event):void
          		{
          			...
          			_svalue = Math.round(200 -(_thumb.y-_boundsLeft)/(_boundsRight-_boundsLeft)*_times);
                      _target.y =  _svalue +_plus ;

                     // numberInput1

                    //  trace(  Math.floor((_svalue - 75)/ 10.41));
                // trace(  12 - (Math.floor((_svalue - 75)/ 10.41)));
                      var ivmNumber:Number =  12 - (Math.floor((_svalue - 75)/ 10.41));
                      _controller.setVSliderNum(ivmNumber);
                      _controller.setVSliderNum2(12 - ivmNumber);

                     // m.numberInput2.text = String(ivmNumber);
          		}
