...
package mvc.view
{
	...
	public class Slider2 extends MovieClip{
   ...
   // public static const SLIDER_CHANGE:String = 'Slider Change';
    ...
    private var _controller;
		...
		public function Slider2(controller, main,target,thumb,left,right,time,plus,start){
			super();
		...
		{         //  trace("move");
            ...
            function ivmSliderSet(e:Event){
                trace("now")
                m.removeEventListener(Event.ENTER_FRAME, loop);
                m.hAreaBar2.x = 296;
            }
            function loop(e:Event):void
          		{
          			...
          			_svalue = Math.round(316-(_thumb.x-_boundsLeft)/(_boundsRight-_boundsLeft)*_times);
                      _target.x =  _svalue +_plus ;

                      var ivmNumber:Number = Math.floor((_svalue - 56)/ 11.3);



                      _controller.setHSliderNum(ivmNumber);
                      _controller.setHSliderNum2(23 - ivmNumber);
